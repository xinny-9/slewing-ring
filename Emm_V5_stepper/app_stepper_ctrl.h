...
#define HOMING_SPEED_RPM      20      /* 回零运行转速 (RPM) */

#define HOMING_TIMEOUT_MS     12000   /* 回零超时时间 (ms) */

#define HOMING_SL_VEL_RPM     8       /* 堵转检测速度阈值 (RPM) */

#define HOMING_SL_CUR_MA      200     /* 堵转检测电流阈值 (mA) */
