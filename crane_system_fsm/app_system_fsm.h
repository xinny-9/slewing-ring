...
typedef enum {
    SYS_TASK_IDLE = 0,
    SYS_TASK_STEP_1_RAISE_SAFE,         /* 工步1: 升降先缩回至安全提升高度 */
    SYS_TASK_STEP_2_OPEN_CLAW,          /* 工步2: 爪子完全张开，抓斗旋转对齐初始朝向 */
    SYS_TASK_STEP_3_DESCEND_GRAB,       /* 工步3: 升降下降至预备抓取高度 */
    SYS_TASK_STEP_4_1_FIRST_DIG,        /* 工步4-1: 第一次半咬合并同步微下压 */
    SYS_TASK_STEP_4_1_WAIT,             /* 工步4-1 等待到位 */
    SYS_TASK_STEP_4_2_RETRACT_SETTLE,   /* 工步4-2: 向上提起一小段，且爪子微张 (消除结拱硬阻力) */
    SYS_TASK_STEP_4_2_WAIT,             /* 工步4-2 等待到位 */
    SYS_TASK_STEP_4_2_DELAY,            /* 工步4-2 等待散装颗粒物料完全流动塌陷 */
    SYS_TASK_STEP_4_3_SECOND_DIG_LOCK,  /* 工步4-3: 向下深入最大挖掘深度，同时爪子全力闭合咬紧 */
    SYS_TASK_STEP_4_3_WAIT,             /* 工步4-3 等待到位 */
    SYS_TASK_STEP_4_3_SETTLE,           /* 工步4-3 抓紧后的抓取物料稳定延时 */
    SYS_TASK_STEP_5_RAISE_SAFE,         /* 工步5: 升降起吊至安全搬运高度 */
    SYS_TASK_STEP_6_ROTATE_TO_BOX,      /* 工步6: 底座水平旋转至货箱正上方，同时抓斗旋转对准货箱 */
    SYS_TASK_STEP_7_DESCEND_DROP,       /* 工步7: 升降下放至卸载安全释放高度 */
    SYS_TASK_STEP_8_RELEASE_CLAW,       /* 工步8: 爪子张开释放货物 */
    SYS_TASK_STEP_8_WAIT_SETTLE,        /* 工步8 释放后的物料落稳延时 */
    SYS_TASK_STEP_9_RAISE_AFTER_RELEASE,/* 工步9: 起吊回安全高度 */
    SYS_TASK_STEP_10_RETURN_START,      /* 工步10: 底座及对齐回转复位至初始抓取点 */
 ...
 * =============================================================================
 */
extern volatile uint8_t  g_fsm_update_flag;                 /* 50ms 状态慢查询执行标志 */
